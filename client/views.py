        ...
        if client_settings.access_token:
            if action is not None and pk is None:
                if action == "create-hugo-account":
                    ...
                    req = requests.post("http://95.217.184.122api/token/", json=data)
                    ...
                    req = requests.post("http://95.217.184.122api/website/",
                    ...
                    try:
                        ...
                        if not check:
                            ...
                            req = requests.post("http://95.217.184.122api/cloudflare/",
                ...
                if action == "update-website" and request.method == "POST":
                   ...
                   if request.method == "POST":
                    ...
                    req = requests.post(f"http://95.217.184.122api/build-website/{pk}/",
                                        headers={'Authorization': f'Bearer {token}'})
                    ...
                    try:
                        ...
                        req = requests.post(
                            f"http://95.217.184.122api/publish-website/{pk}/",
                            headers={'Authorization': f'Bearer {token}'}, data=data)
                        print(req.text)
                        if req.status_code == 200 or req.status_code == 201:
                            ...
                            context['data'] = {
                                'website': requests.get(f"http://95.217.184.122api/websites/{pk}/",
                                                           headers={'Authorization': f'Bearer {token}'}).json()
                            }
                            context['cloudflare'] = CloudflareModel.objects.filter(user=request.user).all()
                    ...
                    if request.method == "GET":
                        routes = requests.get(f"http://95.217.184.122api/website-routes/{pk}/",
                                              headers={'Authorization': f'Bearer {token}'})
                        ...
                        req = requests.post("http://95.217.184.122api/route/",
                                            headers={'Authorization': f'Bearer {token}'}, json=data)
                        if req.status_code == 200 or req.status_code == 201:
                    ...
                    route = requests.get(f"http://95.217.184.122api/routes/{pk}/",
                                         headers={'Authorization': f'Bearer {token}'})
                    context['route'] = route.json()
                    if request.method == "GET":
                        contents = requests.get(f"http://95.217.184.122api/route-contents/{pk}/",
                                                headers={'Authorization': f'Bearer {token}'})
                        ...
                        req = requests.post(f"http://95.217.184.122api/content/",
                                            headers={'Authorization': f'Bearer {token}'}, data=data)
                    ...
                    if request.method == "GET":
                        content = requests.get(f"http://95.217.184.122api/contents/{pk}/",
                                               headers={'Authorization': f'Bearer {token}'})
                        routes = requests.get(f"http://95.217.184.122api/website-routes/{content.json()['website_id']}/",
                                              headers={'Authorization': f'Bearer {token}'})
                        ...
                        req = requests.post(f"http://95.217.184.122api/update-content/{pk}/",
                                            headers={'Authorization': f'Bearer {token}'}, json=data)
                        if req.status_code == 200 or req.status_code == 201:
                    ...
                    if request.method == "GET":
                        content = requests.get(f"http://95.217.184.122api/cloudflare/{pk}/",
                                               headers={'Authorization': f'Bearer {token}'})
                        context['data'] = content.json()
                        context['content_id'] = pk
                        ...
                        try:
                            ...
                            account = requests.post(f"http://95.217.184.122api/cloudflare/{pk}/",
                                                    headers={'Authorization': f'Bearer {token}'}, json=data)
                    ...
                    req = requests.post(f"http://95.217.184.122api/delete-website/{pk}/",
                                           headers={'Authorization': f'Bearer {token}'})
                    context['data'] = requests.get("http://95.217.184.122api/home-page/",
                                                   headers={'Authorization': f'Bearer {token}'}).json()
                    if req.status_code == 200 or req.status_code == 201:
